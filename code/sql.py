...
class Mysql:
    def __init__(self):
        ...
        cursor.execute("create table if not exists appointments (username varchar(20) not null unique, doctor varchar(20), date date, patient varchar(40))")
        cursor.execute("create table if not exists prescriptions (username varchar(20) not null unique, filename varchar(20))")
